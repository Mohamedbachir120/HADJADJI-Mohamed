...
function Home() {
  ...
  return (
    ...
    <h1 className='hello' data-aos="zoom-in" data-aos-duration="1500">{t('hello')}</h1>
    ...
    <h1 className='text-start text-white light-weight'>{t('iam')} </h1>
    <h1 className='text-start text-white'><span className='light-weight'>Mohamed Bachir</span>  HADJADJI</h1>
    <div className='line'></div>
    <p className='text-start text-light mt-3'>{t('Software engineer with 2 Years of Work Experience')}</p>
